  ...
  <q-card style="width: 750px; max-width: 750px;" class="scrollbar-secondary q-pa-sm">
    <q-card-section class=" ">
      <div class="row q-px-none">
        ...
        <q-linear-progress class="q-mt-md" color="indigo-4" :value="100" />
        <div class="col-md-12 col-xs-12">
          <q-input @input="setCandidatesRepresent($event)" autofocus="" :value="candidatesData.candidatesRepresent" label="Candidates representing name"
          ...
          >
            ...
            >
              Reprensenting name is required
            </template>
          </q-input>
        </div>
      </div>
          ...
          <div class="row q-col-gutter-md">
            ...
            <div class=" col-md-6 col-xs-12 q-col-gutter-y-md">
              <div class="col-md-12">
                ...
                <q-input autofocus="" @input="setMaleFullname($event)" :value="candidatesData.male.fullname" class="q-mt-sm" outlined dense
                ...
                >
                  ...
                  >
                    Fullname of the candidate is required
                  </template>
                </q-input>
              </div>
              <div class="col-md-12">
                <label class="text-grey">Year level</label>
                <q-input class="q-mt-sm" @input="setMaleYearlevel($event)" :value="candidatesData.male.yearlevel" outlined dense
                ...
                >
                  ...
                  >
                    Year level of the candidate is required
                  </template>
                </q-input>
              </div>
              <div class="col-md-12">
                <label class="text-grey">Age</label>
                <q-input class="q-mt-sm" @input="setMaleAge($event)" :value="candidatesData.male.age" outlined dense
                ...
                >
                  ...
                  >
                    Age of the candidate is required
                  </template>
                  <template
                    v-slot:error
                    v-else-if="!validations.male.age.numeric"
                  >
                    Invalid age! Tarunga na dra
                  </template>
                </q-input>
              </div>
              <div class="col-md-12">
                <label class="text-grey">Quotes</label>
                <q-input autogrow class="q-mt-sm" @input="setMaleQuotes($event)" :value="candidatesData.male.quotes" outlined dense> </q-input>
              </div>
            </div>
          </div>
        </q-tab-panel>
        ...
        <q-tab-panel name="female">
          <div class="row q-col-gutter-md">
            ...
            <div class=" col-md-6 col-xs-12 q-col-gutter-y-md">
              <div class="col-md-12">
                <label class="text-grey">Full name</label>
                <q-input autofocus="" @input="setFemaleFullname($event)" :value="candidatesData.female.fullname" class="q-mt-sm" outlined dense
              ...
              <div class="col-md-12">
                <label class="text-grey">Year level</label>
                <q-input class="q-mt-sm" @input="setFemaleYearlevel($event)" :value="candidatesData.female.yearlevel" outlined dense
                ...
                >
                  ...
                  >
                    Yearlevel of the candidate is required
                  </template>
                </q-input>
              </div>
              <div class="col-md-12">
                <label class="text-grey">Age</label>
                <q-input class="q-mt-sm" @input="setFemaleAge($event)" :value="candidatesData.female.age" outlined dense
              ...
              <div class="col-md-12">
                <label class="text-grey">Quotes</label>
                <q-input autogrow class="q-mt-sm" @input="setFemaleQuotes($event)" :value="candidatesData.female.quotes" outlined dense> </q-input>
              </div>
            </div>
          </div>
        </q-tab-panel>
